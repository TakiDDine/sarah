...
return  [
    ...
    'faqs' => [
        ...
        '7' => 'لا توجد لديك أية أسئلة حالياً ، يمكنك create أسئلة newة ',
        '8' => 'create new faq',
        '11' => 'created at : ',
        '12' => 'edit ',
        '13' => 'delete ',
   ...
   'pages' => [
    ...
    'settings' => [
        ...
        '151' => 'الallمات المفتاحية',
        '152' => 'تساعدك في الظهور بشall فعال في محركات البحث ، يستحسن ان تضع فيها allمات دلالية على محتوى موقعك ',
        '153' => 'Google Analitycs code',
        '154' => 'هذا الرمز يمكنك الحصول عليه عند create موقعك الى احصيئات جوجل',
        '155' => 'preview ad',
        '156' => 'delete image '
    ],
    ...
    'inboxcreate' => [
        ...
        '307' => 'title email ',
        '308' => 'الtitle سيظهر للمستخدم قبل فتح الرسالة في علبته',
        '309' => 'message',
    ...
    'createads' => [
        ...
        '13' => 'do you need help !',
        '14' => 'تفعيل ad',
        '15' => 'عند تفعيل ad سيظهر - و عدم تفعيله سيجعله ملغيا',
        '16' => 'title ad',
        '17' => 'title , is not important , but it is good for you to reconize ads .',
        '18' => 'ad link',
        '19' => 'تأكد جيداً ان link يبدأ بــ',
        '20' => 'صورة ad',
        '21' => 'يقبل فقط الإمتدادات التالية : ',
        '22' => 'jpeg,png,gif',
        '23' => 'كود إعلان خاص',
        '24' => 'يمكنك create كود أدسنس ، أو اي كود html',
        '25' => 'تنبيه ',
        '26' => 'عند create الكود في ad ، سيتم إلغاء الصورة وlink والنص ',
        '27' => ':',
        '28' => 'not defined',
        '35' => 'preview ad',
        '36' => 'delete image '
    ...
    'socialLinks' => [
        ...
        '189' => 'social media',
        '190' => 'رجاء قم بادخاء link الكامل لموقع التواصل الاجتماعي',
    ...
    'others' => [
        '201' => 'اعدادات أخرى ',
        '202' => 'create أكواد html/css/js في أعلى site ',
        '203' => 'edit ',
        '204' => 'create أكواد html/css/js في أسفل site ',
        '205' => 'edit ',
        ...
        '212' => '',
        '213' => 'تنبيه',
        '214' => 'قبل create اية اكواد تأكد من أنها من مواقع آمنة ، create اكواد غير آمنة قد يؤثر على حماية موقعك'
    ],
    ...
    'bulk_modal' => [
        ...
        '3' => 'delete data',
        '4' => 'عند قيامك بdelete all البيانات فأنت تتحمل كامل المسؤولية ، لا يمكن التراجع عن هذه الخطوة فور اتخاذها ',
        '5' => 'رجاءً، خذ نسخة احتياطية قبل اتخاذ هذا القرار',
        '6' => 'أنا موافق ، رجاءً قم بdelete all البيانات',
        '7' => 'close '
    ],
